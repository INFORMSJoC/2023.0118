...
filenameRegProb = 'BIAS_VAR_MSE_RRMSE_Prob_Reg.csv';
filenameRegExce = 'BIAS_VAR_MSE_RRMSE_Exce_Reg.csv';
filenameRegQaud = 'BIAS_VAR_MSE_RRMSE_Qaud_Reg.csv';
...
n = n*10^4;
MSENestedProbTest = -2*(log(n) - log(100000))/3 - 8.4;
MSENestedExceTest = -2*(log(n) - log(100000))/3 -3.8;
MSENestedQaudTest = -2*(log(n) - log(100000))/3 + 7.45;

MSEFASTProbTest = -4*(log(n) - log(100000))/5 - 9.6;
MSEFASTExceTest = -4*(log(n) - log(100000))/5 - 5.1;
MSEFASTQaudTest = -4*(log(n) - log(100000))/5 + 5.5;
...
MSE2FASTQaudTest = -6*(log(n) - log(10000000))/7 + log(MSE2FASTQaud(3,16)) + 0.1;
