...
X = [SamplePath(:,:,12)' SampleMax(:,:,12)' MaxPre']; 
% outer samples n-by-3d, columns 1-d represent samplepath, columns d+1-2d represent samplemax, 2d+1-3d represent the max value
% samplemax is saved because nested sequential algorithm may generate inner
% smaple in the initial outer sample
