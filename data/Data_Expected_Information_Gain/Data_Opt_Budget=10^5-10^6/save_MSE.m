y1 = load("Optimal_100000.txt");
y2 = load("Optimal_200000.txt");
y3 = load("Optimal_400000.txt");
y4 = load("Optimal_600000.txt");
y5 = load("Optimal_800000.txt");
y6 = load("Optimal_1000000.txt");
