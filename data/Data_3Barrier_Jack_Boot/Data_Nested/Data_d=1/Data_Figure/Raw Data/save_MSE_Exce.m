y1 = load("Nested_Budget=10000_m0=n0=32_d=1.txt");
y2 = load("Nested_Budget=20000_m0=n0=32_d=1.txt");
y3 = load("Nested_Budget=40000_m0=n0=32_d=1.txt");
y4 = load("Nested_Budget=60000_m0=n0=100_d=1.txt");
y5 = load("Nested_Budget=80000_m0=n0=100_d=1.txt");
y6 = load("Nested_Budget=100000_m0=n0=100_d=1.txt");
y7 = load("Nested_Budget=200000_m0=n0=100_d=1.txt");
y8 = load("Nested_Budget=400000_m0=n0=100_d=1.txt");
y9 = load("Nested_Budget=600000_m0=n0=100_d=1.txt");
y10 = load("Nested_Budget=800000_m0=n0=100_d=1.txt");
y11 = load("Nested_Budget=1000000_m0=n0=100_d=1.txt");
y12 = load("Nested_Budget=2000000_m0=n0=100_d=1.txt");
y13 = load("Nested_Budget=4000000_m0=n0=100_d=1.txt");
y14 = load("Nested_Budget=6000000_m0=n0=100_d=1.txt");
y15 = load("Nested_Budget=8000000_m0=n0=100_d=1.txt");
y16 = load("Nested_Budget=10000000_m0=n0=100_d=1.txt");
