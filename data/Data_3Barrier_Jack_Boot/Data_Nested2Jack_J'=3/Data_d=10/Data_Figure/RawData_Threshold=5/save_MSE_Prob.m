y1 = load("Nested2Jack_Budget=10000_m0=30_n0=100_d=10_threshold=5.txt");
y2 = load("Nested2Jack_Budget=20000_m0=30_n0=100_d=10_threshold=5.txt");
y3 = load("Nested2Jack_Budget=40000_m0=30_n0=100_d=10_threshold=5.txt");
y4 = load("Nested2Jack_Budget=60000_m0=60_n0=200_d=10_threshold=5.txt");
y5 = load("Nested2Jack_Budget=80000_m0=60_n0=200_d=10_threshold=5.txt");
y6 = load("Nested2Jack_Budget=100000_m0=60_n0=200_d=10_threshold=5.txt");
y7 = load("Nested2Jack_Budget=200000_m0=60_n0=200_d=10_threshold=5.txt");
y8 = load("Nested2Jack_Budget=400000_m0=60_n0=200_d=10_threshold=5.txt");
y9 = load("Nested2Jack_Budget=600000_m0=60_n0=200_d=10_threshold=5.txt");
y10 = load("Nested2Jack_Budget=800000_m0=60_n0=200_d=10_threshold=5.txt");
y11 = load("Nested2Jack_Budget=1000000_m0=60_n0=200_d=10_threshold=5.txt");
y12 = load("Nested2Jack_Budget=2000000_m0=60_n0=200_d=10_threshold=5.txt");
y13 = load("Nested2Jack_Budget=4000000_m0=60_n0=200_d=10_threshold=5.txt");
y14 = load("Nested2Jack_Budget=6000000_m0=60_n0=200_d=10_threshold=5.txt");
y15 = load("Nested2Jack_Budget=8000000_m0=60_n0=200_d=10_threshold=5.txt");
y16 = load("Nested2Jack_Budget=10000000_m0=60_n0=200_d=10_threshold=5.txt");
...
writematrix(MSE_Prob,"BIAS_VAR_MSE_RRMSE_Prob_Nested2Jack.csv")