%y1 = load("NestedJack_Budget=10000_m0=n0=32_d=10_threshold=5.txt");
y2 = load("NestedJack_Budget=20000_m0=n0=32_d=10_threshold=5.txt");
y3 = load("NestedJack_Budget=40000_m0=n0=32_d=10_threshold=5.txt");
y4 = load("NestedJack_Budget=60000_m0=n0=100_d=10_threshold=5.txt");
y5 = load("NestedJack_Budget=80000_m0=n0=100_d=10_threshold=5.txt");
y6 = load("NestedJack_Budget=100000_m0=n0=100_d=10_threshold=5.txt");
y7 = load("NestedJack_Budget=200000_m0=n0=100_d=10_threshold=5.txt");
y8 = load("NestedJack_Budget=400000_m0=n0=100_d=10_threshold=5.txt");
y9 = load("NestedJack_Budget=600000_m0=n0=100_d=10_threshold=5.txt");
y10 = load("NestedJack_Budget=800000_m0=n0=100_d=10_threshold=5.txt");
y11 = load("NestedJack_Budget=1000000_m0=n0=100_d=10_threshold=5.txt");
y12 = load("NestedJack_Budget=2000000_m0=n0=100_d=10_threshold=5.txt");
y13 = load("NestedJack_Budget=4000000_m0=n0=100_d=10_threshold=5.txt");
y14 = load("NestedJack_Budget=6000000_m0=n0=100_d=10_threshold=5.txt");
y15 = load("NestedJack_Budget=8000000_m0=n0=100_d=10_threshold=5.txt");
%y16 = load("NestedJack_Budget=10000000_m0=n0=100_d=10_threshold=5.txt");
...
writematrix(MSE_Exce,"BIAS_VAR_MSE_RRMSE_Exce_NestedJack.csv")