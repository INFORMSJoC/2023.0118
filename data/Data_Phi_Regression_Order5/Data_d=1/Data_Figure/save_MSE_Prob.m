y1 = load("RegResult_Budget=10000_m=1_d=1_basis4.txt");
y2 = load("RegResult_Budget=20000_m=1_d=1_basis4.txt");
y3 = load("RegResult_Budget=40000_m=1_d=1_basis4.txt");
y4 = load("RegResult_Budget=60000_m=1_d=1_basis4.txt");
y5 = load("RegResult_Budget=80000_m=1_d=1_basis4.txt");
y6 = load("RegResult_Budget=100000_m=1_d=1_basis4.txt");
y7 = load("RegResult_Budget=200000_m=1_d=1_basis4.txt");
y8 = load("RegResult_Budget=400000_m=1_d=1_basis4.txt");
y9 = load("RegResult_Budget=600000_m=1_d=1_basis4.txt");
y10 = load("RegResult_Budget=800000_m=1_d=1_basis4.txt");
y11 = load("RegResult_Budget=1000000_m=1_d=1_basis4.txt");
y12 = load("RegResult_Budget=2000000_m=1_d=1_basis4.txt");
y13 = load("RegResult_Budget=4000000_m=1_d=1_basis4.txt");
y14 = load("RegResult_Budget=6000000_m=1_d=1_basis4.txt");
y15 = load("RegResult_Budget=8000000_m=1_d=1_basis4.txt");
y16 = load("RegResult_Budget=10000000_m=1_d=1_basis4.txt");
...
writematrix(MSE_Prob,"BIAS_VAR_MSE_RRMSE_Prob_Reg.csv")